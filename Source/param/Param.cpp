...
namespace param
{
	...
	String toTooltip(PID pID)
	{
		...
		case PID::Muffle: return "A 6db/oct lowpass-Filter.";
...
namespace param
{
		...
		modDepthLocked(false)
	{
		...
		params.push_back(makeParam(PID::Muffle, state, 20000.f, makeRange::withCentre(20.f, 20000.f, 2000.f), Unit::Hz));
